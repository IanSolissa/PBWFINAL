    ...
    <div class="col-lg-8">
        ...
        <form method="post" action="/Dashboard" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <input value="{{ old('judul_berita') }}"; type="text" class="form-control"; id="judul_berita" ;
                    aria-describedby="emailHelp"; name="judul_berita" ; autofocus;>
            ...
            <div class="mb-3">
                ...
                <input value="{{ old('isi_berita') }}"id="isi_berita" type="hidden"
                    name="isi_berita">
      ...
      <label class="form-check-label" for="exampleCheck1">Check me out</label>
            ...
            <button type="submit" class="btn btn-primary" style="margin-top:3%;">Create Project</button>
        </form>
    </div>
